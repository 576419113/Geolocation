...
import ipaddress
import maxminddb
city_reader = maxminddb.open_database('resource/GeoLite2-City.mmdb')
asn_reader = maxminddb.open_database('resource/GeoLite2-ASN.mmdb')
cn_reader = maxminddb.open_database('resource/GeoCN.mmdb')
lang = ["zh-CN","en"]
asn_map = {
    9812:"东方有线",
    9389:"中国长城",
